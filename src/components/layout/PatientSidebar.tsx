...
export default function PatientSidebar({ patientName }: PatientSidebarProps) {
  ...
  const navItems = [
    ...
    { href: "/patient/appointments", label: nav.appointments, icon: CalendarDays },
    { href: "/patient/tasks", label: nav.tasks, icon: CheckSquare },
    { href: "/patient/history", label: nav.history, icon: Clock },
  ];
